...
const sectionJugador = document.getElementById('ataqueJugador')
const sectionEnemigo = document.getElementById('ataqueEnemigo')

const sectionMensajes = document.getElementById('resultados')
const sectionAtks = document.getElementById('atks')
...
function mostrarAtaques(ataques) {
    ataques.forEach((ataque) =>{
        ataquesMokepon = `
        <button class = "botonAtaque BAtaque" id=${ataque.id}>${ataque.nombre}</button>
        `
        sectionAtks.innerHTML += ataquesMokepon
    })
...
function crearMensaje(resultado) {
    ...
    let infoJugador = document.createElement('p')
    infoJugador.innerHTML=ataqueJugador
    sectionJugador.appendChild(infoJugador)

    let infoEnemigo = document.createElement('p')
    infoEnemigo.innerHTML=ataqueEnemigo
    sectionEnemigo.appendChild(infoEnemigo)
}
function crearMensajeFinal(resultadoFinal) {
    sectionMensajes.innerHTML = resultadoFinal

    sectionReiniciar.style.display = 'flex'
    sectionAtks.style.display = 'none'
}
